...
mod test {
    ...
    use sparkle_core::model::kasplex::v1::Protocol;
    #[cfg(not(target_arch = "wasm32"))]
    ...
    use sparkle_core::model::kasplex::v1::krc20::TokenTransaction;
    ...
    pub fn test_and_verify_sign() {
        ...
        let script_sig: Vec<u8> =
            redeem_pubkey(json.as_bytes(), &public_key.serialize()[1..33]).unwrap();
